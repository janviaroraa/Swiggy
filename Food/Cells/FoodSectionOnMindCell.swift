...
/// CollectionViewCell for (Food Section 4: Personalised Food Items)
class FoodSectionOnMindCell: UICollectionViewCell {

    weak var delegate: SectionItemsActionCellDelegate?
    var viewModel: FoodSectionOnMindViewModel?
    ...
    private func registerViewModel() {
        viewModel = FoodSectionOnMindViewModel()
...
extension FoodSectionOnMindCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension FoodSectionOnMindCell: FoodSectionOnMindViewModelDelegate {
    func didFetchData() {
